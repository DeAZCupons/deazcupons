...
import { Plus, Edit, Trash2, ShieldCheck, Mail } from 'lucide-react'
              ...
              <tr key={member.id} className={`${idx % 2 === 0 ? 'bg-white' : 'bg-[#F9FAFB]'} text-sm hover:bg-blue-50/30 transition-colors`}>
                ...
                <td className="p-4 text-right">
                  <div className="flex justify-end gap-2">
                    <button className="p-2 text-[#7B8490] hover:text-blue-600"><Edit size={16} /></button>
                    <button className="p-2 text-[#7B8490] hover:text-red-600"><Trash2 size={16} /></button>
                  </div>
                </td>
              </tr>
            ))}
